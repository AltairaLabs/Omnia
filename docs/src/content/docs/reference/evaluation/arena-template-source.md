...
ArenaTemplateSource is an enterprise feature. The CRD is only installed when `enterprise.enabled=true` in your Helm values. See [Installing a License](/how-to/operations/install-license/) for details.
:::
...
- **[ArenaSource](/reference/evaluation/arenasource)**: For fetching PromptKit bundles (not templates)
- **[ArenaJob](/reference/evaluation/arenajob)**: Execute tests using Arena projects
- **[Project Editor](/how-to/evaluation/use-arena-project-editor)**: Create projects from templates
