...
[Define Functions](/how-to/agents/define-functions/).
...
- [Define Functions](/how-to/agents/define-functions/) — author a function in the first place
- [Configure Authentication](/how-to/security/configure-authentication/) — the auth chain that MCP shares
