...
[deploy an agent-mode AgentRuntime](/how-to/agents/expose-agents/) instead.
...
[AgentRuntime reference](/reference/core/agentruntime/#outputformat).
...
See [Configure Authentication](/how-to/security/configure-authentication/) for
