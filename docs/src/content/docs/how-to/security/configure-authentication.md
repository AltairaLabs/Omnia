...
- [Configure Dashboard Authentication](/how-to/security/configure-dashboard-auth/) — set up user authentication
- [Authentication Architecture](/explanation/security/authentication/) — the full auth model
