...
The Project Editor is an enterprise feature. Enable it with `enterprise.enabled=true` in your Helm values. See [Installing a License](/how-to/operations/install-license/) for details.
:::
...
- **[ArenaTemplateSource CRD](/reference/evaluation/arena-template-source)**: Template source configuration
- **[ArenaDevSession CRD](/reference/evaluation/arena-dev-session)**: Interactive testing sessions
- **[Monitor Arena Jobs](/how-to/evaluation/monitor-arena-jobs)**: Track evaluation progress
