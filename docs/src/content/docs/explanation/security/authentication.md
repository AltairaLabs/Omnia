...
| clientKeys | Per-caller keys with scopes, managed in UI | In-facade (sha256 lookup) |
...
[Configure Agent Authentication](/how-to/security/configure-authentication/) for
recipes.
