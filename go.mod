...
require (
	...
	github.com/AltairaLabs/PromptKit/pkg v1.3.7
	github.com/AltairaLabs/PromptKit/runtime v1.3.7
	github.com/AltairaLabs/PromptKit/sdk v1.3.7
...
require (
	...
	github.com/AltairaLabs/PromptKit/server/a2a v1.3.7 // indirect
