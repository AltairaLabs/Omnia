...
require (
	...
	github.com/AltairaLabs/PromptKit/pkg v1.3.6
	github.com/AltairaLabs/PromptKit/runtime v1.3.6
	github.com/AltairaLabs/PromptKit/sdk v1.3.6
...
require (
	...
	github.com/AltairaLabs/PromptKit/server/a2a v1.3.6 // indirect
