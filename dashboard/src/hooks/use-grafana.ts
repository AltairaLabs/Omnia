...
export const QUALITY_PANELS = {
  AVERAGE_SCORE: 1,
  LOWEST_SCORE: 2,
  ACTIVE_EVAL_METRICS: 3,
  DISTINCT_EVAL_TYPES: 4,
  EVAL_SCORES_OVER_TIME: 5,
  CURRENT_SCORES_BY_EVAL: 6,
  AVERAGE_SCORE_BY_AGENT: 7,
  AVERAGE_SCORE_BY_PACK: 8,
  EVAL_SCORE_DETAILS: 9,
} as const;
