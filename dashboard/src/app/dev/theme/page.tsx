...
// React Flow is browser-only (no SSR), so mount it client-side only — matches
// how the topology/workload-graph pages load their flow views.
const ThemeFlow = dynamic(() => import("./theme-flow"), { ssr: false });
    ...
    <div className="space-y-8 p-8" data-testid="theme-preview">
      ...
      <Section title="React Flow">
        <div
          ...
          data-testid="theme-preview-flow"
        >
          <ThemeFlow />
        </div>
      </Section>
