/**
 * Tests for the privacy enforcement stats proxy route.
 */
...
function createRequest(): NextRequest {
  return new NextRequest(
    `https://localhost:3000/api/workspaces/test-ws/privacy/enforcement-stats`,
    { method: "GET" },
  );
}

describe("GET /api/workspaces/[name]/privacy/enforcement-stats", () => {
  beforeEach(() => {
    vi.resetModules();
  });
  ...
  it("proxies to privacy-api enforcement stats endpoint", async () => {
    ...
    expect(fetchUrl).toContain("/api/v1/privacy/enforcement-stats");
