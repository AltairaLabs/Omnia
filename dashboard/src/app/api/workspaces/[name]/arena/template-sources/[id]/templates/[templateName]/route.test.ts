/**
 * Tests for specific template API route.
 */
...
function createMockRequest(): NextRequest {
  return new NextRequest(
    "http://localhost:3000/api/workspaces/test-ws/arena/template-sources/test-source/templates/basic-chatbot"
  );
}
...
describe("GET /api/workspaces/[name]/arena/template-sources/[id]/templates/[templateName]", () => {
  beforeEach(() => {
    vi.resetModules();
  });
