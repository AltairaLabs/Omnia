# Omnia Project Governance

## Overview

Omnia is an open source project developed by [AltairaLabs](https://altairalabs.ai) and is committed to building a welcoming and diverse community. This document describes the governance structure and processes for the Omnia project.

## Project Goals

Omnia aims to provide:
- A Kubernetes operator for deploying and managing AI agents
- Custom Resource Definitions (CRDs) for declarative agent configuration
- WebSocket facade for real-time client-agent communication
- Session management for persistent conversation state
- Integration with PromptKit for prompt configuration and tool execution
...
- Breaking changes to CRDs or APIs
...
The maintainers are responsible for enforcing the [Code of Conduct](./CODE_OF_CONDUCT.md). This includes:
...
- **Email**: Private communications to [conduct@altairalabs.ai](mailto:conduct@altairalabs.ai)
