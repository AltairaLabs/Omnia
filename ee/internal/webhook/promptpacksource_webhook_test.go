...
func TestPromptPackSourceValidatorValidateCreate(t *testing.T) {
	tests := []struct {
		name        string
	...
	validator := &PromptPackSourceValidator{LicenseValidator: nil}
...
func TestPromptPackSourceValidatorValidateUpdate(t *testing.T) {
	validator := &PromptPackSourceValidator{LicenseValidator: nil}

	oldSource := &omniav1alpha1.PromptPackSource{
		ObjectMeta: metav1.ObjectMeta{Name: "test-source", Namespace: "default"},
		Spec: omniav1alpha1.PromptPackSourceSpec{
			Type: omniav1alpha1.PromptPackSourceTypeGit,
		},
	}
	newSource := &omniav1alpha1.PromptPackSource{
		ObjectMeta: metav1.ObjectMeta{Name: "test-source", Namespace: "default"},
		Spec: omniav1alpha1.PromptPackSourceSpec{
			Type: omniav1alpha1.PromptPackSourceTypeOCI,
		},
...
func TestPromptPackSourceValidatorValidateDelete(t *testing.T) {
	validator := &PromptPackSourceValidator{LicenseValidator: nil}
...
func TestPromptPackSourceValidateLicenseNoValidator(t *testing.T) {
	validator := &PromptPackSourceValidator{LicenseValidator: nil}
...
func TestPromptPackSourceValidateLicenseDevMode(t *testing.T) {
	licenseValidator, err := license.NewValidator(nil, license.WithDevMode())
	if err != nil {
		t.Fatalf("failed to create license validator: %v", err)
	}

	validator := &PromptPackSourceValidator{LicenseValidator: licenseValidator}
...
func TestPromptPackSourceValidateLicenseOpenCoreRestriction(t *testing.T) {
