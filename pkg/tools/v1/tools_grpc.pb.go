...
const (
	ToolService_Execute_FullMethodName   = "/omnia.tools.v1.ToolService/Execute"
	ToolService_ListTools_FullMethodName = "/omnia.tools.v1.ToolService/ListTools"
)
...
type ToolServiceClient interface {
	...
	Execute(ctx context.Context, in *ToolRequest, opts ...grpc.CallOption) (*ToolResponse, error)
...
func (c *toolServiceClient) Execute(ctx context.Context, in *ToolRequest, opts ...grpc.CallOption) (*ToolResponse, error) {
...
func (UnimplementedToolServiceServer) Execute(context.Context, *ToolRequest) (*ToolResponse, error) {
...
func _ToolService_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ToolServiceServer).Execute(ctx, req.(*ToolRequest))
	}
...
var ToolService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "omnia.tools.v1.ToolService",
	...
	Metadata: "api/proto/tools/v1/tools.proto",
}
